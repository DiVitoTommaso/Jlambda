...
public class JlambdaParser extends Parser {
	...
	public static final int
		...
		FLOAT=25, INT=26, BOOL=27, VARIABLE=28, COMMENT=29, WS=30;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"STRING", "FLOAT", "INT", "BOOL", "VARIABLE", "COMMENT", "WS"
		};
	}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 522492416L) != 0) {
				{
				{
				setState(16);
				_errHandler.sync(this);
	...
	public final SubexprContext subexpr() throws RecognitionException {
		...
		try {
			...
			case T__8:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 522492416L) != 0) {
					{
					setState(54);
					expr();
					}
